...
const { facebookLogin, register, login, loginGoogle, forgetPassword, resetPassword, getPrivacyPolicy, getTermsOfService, verification } = require("../controllers/auth-controller");
